...
{	
	...
	{
	case 1:
		DrawString(0, 0, "勝利！", Color::RESULT_WIN_CHAR);
		break;
	case 0:
		DrawString(0, 0, "引き分け", Color::RESULT_DRAW_CHAR);
		break;
	case -1:
		DrawString(0, 0, "敗北 ...", Color::RESULT_LOSE_CHAR);
		break;
	default:
		break;
	}
	...
	// 石の数
	DrawFormatString(0, title_font_size_, Color::RESULT_STONES_CHAR,     "あなた: %d 石", human_stones_);
	DrawFormatString(0, title_font_size_ + normal_font_size_, Color::RESULT_STONES_CHAR, "    AI: %d 石", ai_stones_);
	// ボタン
	title_btn_.Draw();
	exit_btn_.Draw();
}
